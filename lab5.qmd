...
**Open RobotGLP.sav** -- Thanks to [Jingxi](https://www.lancaster.ac.uk/lums/people/jingxi-huang) for allowing us to use a subset of her data to test the above model.
...
To rerun your regression, install and use the 'HeteroskedasticityV3.spd' macro developed by yours truly[^lab5-2]. The macro produces regression outputs with/without heteroscedasticity-adjusted standard errors.

[^lab5-2]: Daryanto, A. (2020). Tutorial on heteroskedasticity using heteroskedasticityV3 SPSS macro. The Quantitative Methods for Psychology, 16(5), 8-20

## Installing the HeteroskedasticityV3 Macro {#sec-install}
...
-   <https://github.com/ahmaddaryanto/Heteroskedasticity>
...
![HeteroskedaticityV3 Macro in the SPSS menu after installation](images/lab5_macro_path.png)

![HeteroskedaticityV3 Macro](images/lab5_macro.png)
...
-   Go back to the download folder in your PC where you have downloaded several files from this page <https://github.com/ahmaddaryanto/Heteroskedasticity> (see @sec-install)
...
#[2023](https://dtu-panopto.lancs.ac.uk/Panopto/Pages/Viewer.aspx?id=a8f3e3c0-35c3-477c-950f-afa3007195b2) [2024](https://lancaster.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=a65c307c-1b84-4d05-a135-b11000598009#)
```
...
[Regression diagnostics](https://dtu-panopto.lancs.ac.uk/Panopto/Pages/Viewer.aspx?id=5ba02b44-b4d1-4b70-ab45-acb900dc20a4)
