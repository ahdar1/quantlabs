...
> A binary logistic regression was conducted to examine factors influencing consumers' decision to join a green loyalty programme. The model was significant, $\chi^2(4)=473.548$, \(p<.001\), indicating that anticipated guilt, perceived attractiveness, age, and gender collectively improved prediction of joining behaviour. The model explained approximately 21.8% of the variation in joining behaviour $\text{Nagelkerke } R^2$ value of 0.218 and correctly classified 88.7% of respondents. Perceived attractiveness (\(OR=2.392\), \(p<.001\)) emerged as the strongest predictor, with a one-unit increase in attractiveness associated with approximately 2.39 times greater odds of joining the programme. Anticipated guilt also positively influenced participation (\(OR=1.718\), \(p<.001\)), whereas age had a small negative effect (\(OR=0.967\), \(p<.001\)). Gender was not a significant predictor (\(OR=1.144\), \(p=.207\)).
