# Influential Observations (to be deployed in the academic year 2025/26) {#sec-lab6}
...
![Data](images/influential1.png){width="200"}

For an illustration, we use the above data, which contains only 5 observations. I used this data to produce the first scatter plot presented earlier.
...
Intention to join the green LP = $\beta_0$ + $\beta_1$ Anticipated Guilt + $\beta_2$ Perceived Attractiveness + $\beta_3$ Age + $\beta_4$ Gender + error.
:::
