# Mediation Analysis (Extra) {#sec-lab6}
...
![Simple linear model](images/lab6_model1.png "Simple linear regression model"){#fig-slr fig-align="center" width="90%"}

and the model in @fig-med with anticipated guilt (`Guilt`) being added.

![Mediation model](images/lab6_model2.png){#fig-med fig-align="center" width="90%"}
...
![Replace the question marks with numbers](images/lab6_model3.png){fig-align="center" width="90%"}
:::
...
![Process Macro](images/lab6_process_win.png){fig-align="center" width="90%"}
...
![Last part of the Process macro's outputs](images/lab6_process_out.png){#fig-processout fig-align="center" width="90%"}
