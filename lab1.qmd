# Getting started with SPSS (Week 13) {#sec-lab1}

Data: Dell.sav

-   Data is available on [Moodle](https://modules.lancaster.ac.uk/course/view.php?id=35502#section-6).

-   On Moodle, go to a section `Workshop Materials`, and open a folder `Workshop 1, 2, 3 - Data and Articles`. Download Dell.sav and **Dell Questionnaire** .
...
Open the data file Dell.sav, which you must download from [Moodle](https://modules.lancaster.ac.uk/mod/folder/view.php?id=1467299). You should save the data to your own drive and then double-click the file name from windows explorer.
...
Lancaster University has a subscription to an online survey Qualtrics. You can use your university email to log onto Qualtrics.

::: callout-note
## Task

Click this link [https://lancasteruni.eu.qualtrics.com](https://lancasteruni.eu.qualtrics.com/homepage/ui), and log onto Qualtrics.
:::

::: {.callout-important style="color:red"}
Find more information about Qualtrics (e.g., training, how to create and edit a survey, etc) at the ISS page [here](https://answers.lancaster.ac.uk/display/ISS/Qualtrics+access%2C+help+and+training)
:::
